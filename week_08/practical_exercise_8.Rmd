...
Sys.setenv(RETICULATE_PYTHON = "/Users/ottosejrskildsantesson/opt/miniconda3/bin/python")
library(reticulate)
...
data.shape
# 682  number of repetitions of visual stimuli
# 102 n pof sensors recording magnetic fields
# 251 number of time samples
# "The first dimension is number of repetitions of a visual stimulus , the second dimension is the number of sensors that record magnetic fields (in Tesla) that stem from neurons activating in the brain, and the third dimension is the number of time samples."
...
```{python}
avr_rep = np.mean(data, axis=0)
print(avr_rep)
avr_rep.shape # I get the two dimensions, although with the magnetic field as the first, and time as the second
```
